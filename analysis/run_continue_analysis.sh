...
#SBATCH --array=94-94            # specifies the slurm array job with the number of tasks
...
PREV_NRUNS=20000 # which previous sampling to continue
...
# alternative setup for DREAMzs
# Rscript analysis/03b_continue_mcmc_rsofun.R "out_calib__scen${SLURM_ARRAY_TASK_ID}_DREAMzs-${PREV_NRUNS}-0iter_8x3chains_on_CPU8x1.rds" "${NEW_NRUNS}"
