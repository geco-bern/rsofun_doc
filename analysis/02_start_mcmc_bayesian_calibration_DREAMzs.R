...
# 1. calibration scenario [220, 221, 229, 231]
# 2. burnin iterations
...
# Example:
# Rscript -e 'renv::run("analysis/02_start_mcmc_bayesian_calibration_DREAMzs.R", project = "../rsofun_doc", args = c(231,11,51))'
...
timings <- run_mcmc_rsofun(
  ...
  outpath = outpath, logpath = file.path(outpath, "timings", paste0(fname,"_log.txt")), sampler = "DREAMzs"
)
