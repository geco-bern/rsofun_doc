#! /usr/bin/bash -l
#SBATCH --job-name="s94_posteriorSensitivity"
...
TARGETS_LIST=("all" "gpp" "vj" "bigD13C")
TARGET="${TARGETS_LIST[$SLURM_ARRAY_TASK_ID]}"
...
Rscript "analysis/02_sensitivity_analysis.R" "94" "train" "${TARGET}" "${NRUNS}"
