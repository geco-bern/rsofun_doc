...
#SBATCH --array=93,94,95 # specifies the slurm array job with the number of tasks
...
NRUNS=80000     # which MCMC sampling to use
...
Rscript analysis/04_make-test-train_predictions.R "out_calib__scen${SLURM_ARRAY_TASK_ID}_DEzs-${NRUNS}-0iter_8x3chains_on_CPU8x1_continued.rds" "22000" "${NPREDICTIONS}" "8" "${NERRORS}"
